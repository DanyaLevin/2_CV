...
let itemsToExpand = [
    ...
    'tra-6-est-more', 'tra-6-des-more',
    'tra-5-est-more', 'tra-5-des-more',
    'tra-4-est-more', 'tra-4-des-more',
    'tra-3-est-more', 'tra-3-des-more',
    'tra-2-est-more', 'tra-2-des-more',
    'tra-1-est-more', 'tra-1-des-more'];
...
toggleMore('exp-4-ach', 'exp-4-ach-more');
...
toggleMore('tra-6-est', 'tra-6-est-more');
toggleMore('tra-6-des', 'tra-6-des-more');
toggleMore('tra-5-est', 'tra-5-est-more');
toggleMore('tra-5-des', 'tra-5-des-more');
